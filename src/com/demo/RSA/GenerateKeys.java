...
public class GenerateKeys {
    public static void generate(){
        try {
            ...
            File publicKeyFile = createKeyFile(new File("D:\\CRYPPT\\demo1\\src\\com\\demo\\RSA/publicKey.txt"));
            File privateKeyFile = createKeyFile(new File("D:\\CRYPPT\\demo1\\src\\com\\demo\\RSA/privateKey.txt"));
